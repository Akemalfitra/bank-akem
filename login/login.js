...
accounts.push({
    owner: 'Akem Akun',
    movements: [300, -200, 150, -50, 1000],
    interestRate: 1.5, // %
    pin: 1111,
    movementsDates: [
        '2023-01-01T13:15:33.035Z',
        '2023-02-01T09:48:16.867Z',
        '2023-03-01T06:04:23.907Z',
        '2023-04-01T14:18:46.235Z',
        '2023-05-01T16:33:06.386Z',
    ],
    currency: 'USD',
    locale: 'en-US',
    username: 'akem',
...
btnLogin.addEventListener('click', function (e) {
    e.preventDefault();
    console.log('Input Username:', inputLoginUsername.value);
    console.log('Input PIN:', inputLoginPin.value);
    ...
    if (currentAccount && currentAccount.pin === Number(inputLoginPin.value)) {
        ...
        // Update UI, clear inputs, etc.
    } else {
        console.log('Login failed!');
    }
});
// Menambahkan akun baru dengan username 'hakim' dan password 2222
accounts.push({
    owner: 'Hakim Akun',
    movements: [500, -300, 200, -100, 1500],
    interestRate: 1.5, // %
    pin: 2222,
    movementsDates: [
        '2023-01-10T10:15:33.035Z',
        '2023-02-15T09:48:16.867Z',
        '2023-03-20T06:04:23.907Z',
...
btnLogin.addEventListener('click', function (e) {
    ...
    // Debugging: log input user
    console.log('Input Username:', inputLoginUsername.value);
    console.log('Input PIN:', inputLoginPin.value);

    // Mencari akun yang sesuai dengan username
    currentAccount = accounts.find(acc => acc.username === inputLoginUsername.value);
    console.log('Matched Account:', currentAccount);
    ...
    if (currentAccount && currentAccount.pin === Number(inputLoginPin.value)) {
        ...
        // Update UI dengan akun yang sesuai
        ...
        // Reset timer jika sudah dimulai
        ...
        console.log('Login failed!');
        warningText.textContent = 'Invalid username or password!';
